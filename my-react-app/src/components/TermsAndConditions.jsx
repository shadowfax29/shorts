  ...
  return (
    <main className={styles.page}>
      ...
      <div className={styles.container}>
        ...
        <p>
          Welcome to downloadshorts.com! These terms and conditions outline the rules and
          regulations for the use of downloadshorts.com's Website, located at{' '}
          <a href="https://downloadshorts.com">https://downloadshorts.com</a>.
        </p>
        <p>
          By accessing this website we assume you accept these terms and conditions. Do not
          continue to use downloadshorts.com if you do not agree to take all of the terms and
          conditions stated on this page.
        </p>
        <p>
          The following terminology applies to these Terms and Conditions, Privacy Statement and
          Disclaimer Notice and all Agreements: "Client", "You" and "Your" refers to you, the
          person logged on to this website and compliant to the Company's terms and conditions.
        ...
        <h2>Cookies</h2>
        <p>
          We employ the use of cookies. By accessing downloadshorts.com, you agreed to use cookies
          in agreement with downloadshorts.com's Privacy Policy.
        </p>
        <p>
        ...
        <h2>License</h2>
        <p>
          Unless otherwise stated, downloadshorts.com and/or its licensors own the intellectual
          property rights for all material on downloadshorts.com. All intellectual property rights
          are reserved. You may access this from downloadshorts.com for your own personal use
          subjected to restrictions set in these terms and conditions.
        </p>
        <p>You must not:</p>
        <ul>
          <li>Republish material from downloadshorts.com</li>
          <li>Sell, rent or sub-license material from downloadshorts.com</li>
          <li>Reproduce, duplicate or copy material from downloadshorts.com</li>
          <li>Redistribute content from downloadshorts.com</li>
        </ul>
        <p>
          Parts of this website offer an opportunity for users to post and exchange opinions and
          information in certain areas of the website. downloadshorts.com does not filter, edit,
          publish or review Comments prior to their presence on the website. Comments do not
          reflect the views and opinions of downloadshorts.com, its agents and/or affiliates.
          Comments reflect the views and opinions of the person who posts their views and opinions.
          To the extent permitted by applicable laws, downloadshorts.com shall not be liable for
        ...
        <p>
          downloadshorts.com reserves the right to monitor all Comments and to remove any Comments
        ...
        <p>
          You hereby grant downloadshorts.com a non-exclusive license to use, reproduce, edit and
        ...
        <p>
          ...
          visibility of the hyperlink compensates the absence of downloadshorts.com; and (d) the
        ...
        <p>
          ...
          website, you must inform us by sending an e-mail to downloadshorts.com. Please include
        ...
        <p>
          No use of downloadshorts.com's logo or other artwork will be allowed for linking absent a
