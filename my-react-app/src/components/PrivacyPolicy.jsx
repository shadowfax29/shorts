...
const BREADCRUMB_SCHEMA = JSON.stringify({
  ...
  itemListElement: [
    ...
    { '@type': 'ListItem', position: 2, name: 'Privacy Policy', item: 'https://downloadshorts.com/privacy-policy' },
  ],
});
  ...
  return (
    <main className={styles.page}>
      ...
      <div className={styles.container}>
        ...
        <p>
          At downloadshorts.com, accessible from{' '}
          <a href="https://downloadshorts.com">https://downloadshorts.com</a>, one of our main
          priorities is the privacy of our visitors. This Privacy Policy document contains types of
          information that is collected and recorded by downloadshorts.com and how we use it.
        </p>
        <p>
        ...
        <p>
          ...
          downloadshorts.com. This policy is not applicable to any information collected offline or
        ...
        <h2>Log Files</h2>
        <p>
          downloadshorts.com follows a standard procedure of using log files. These files log
        ...
        <p>
          Like any other website, downloadshorts.com uses cookies. These cookies are used to store
        ...
        <p>
          ...
          downloadshorts.com, which are sent directly to users browser. They automatically receive
        ...
        <p>
          Note that downloadshorts.com has no access to or control over these cookies that are used
          by third-party advertisers.
        </p>

        <h2>Third Party Privacy Policies</h2>
        <p>
          downloadshorts.com's Privacy Policy does not apply to other advertisers or websites.
        ...
        <p>
          downloadshorts.com does not knowingly collect any Personal Identifiable Information from
